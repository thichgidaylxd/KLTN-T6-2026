...
export function DeleteWarehouseItemModal({ item, isOpen, onClose, onConfirm, loading }: Props) {
  return (
      ...
      <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-md flex flex-col overflow-hidden border border-slate-100">
        <div className="flex items-center justify-between px-8 py-6 border-b border-slate-50 shrink-0">
          <div className="flex items-center gap-4 text-left">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-800 tracking-tight">Xóa vật tư</h2>
              <p className="text-xs text-slate-400 font-medium mt-0.5">Hành động này không thể hoàn tác</p>
            </div>
          </div>
        ...
        <div className="p-8 space-y-4">
          <div className="bg-rose-50/50 border border-rose-100 rounded-2xl p-4 flex items-start gap-3">
            ...
            <p className="text-[13px] text-rose-700 leading-relaxed font-medium">
              Bạn đang yêu cầu xóa vật tư <span className="font-bold underline">"{item.name}"</span>. 
              Mọi dữ liệu tồn kho liên quan đến vật tư này sẽ bị loại bỏ vĩnh viễn khỏi hệ thống.
            </p>
          </div>
          
          <p className="text-sm text-slate-500 text-center px-4">
            Để tiếp tục, vui lòng xác nhận bạn thực sự muốn thực hiện hành động này.
          </p>
        </div>
